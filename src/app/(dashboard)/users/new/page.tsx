  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Novo Usuário</h1>
          <p className="text-sm text-zinc-500">Crie um novo usuário para acessar o sistema</p>
        </div>
      </div>
